...
contract('Lottery', (accounts) => {
    it('init', async () => {
        ...
        this.swpy = await MockBEP20.deployed();
        ...
        await this.swpy.transfer(bob, '2000', { from: minter });
        await this.swpy.transfer(alice, '2000', { from: minter });
        await this.swpy.transfer(carol, '2000', { from: minter });
    });
    ...
    it('test', async () => {
        ...
        carol=accounts[3];
        dev=accounts[4];
        await this.swpy.approve(this.lotteryProxyAddress, '1000', { from: alice });
        await this.swpy.approve(this.lotteryProxyAddress, '1000', { from: bob });
        ...
        assert.equal((await this.swpy.balanceOf(this.lotteryProxyAddress)).toString(), '418');
